...
I created multiple models using ARIMA, linear regression and LSTM with various combinations of features and weighting.

The ARIMA model showed some of the characteristics I was expecting, but required some guidance that reduced my confidence level in the predictions.

The polynomial linear regression model looks great.  This is the graph I will use personally until I can improve upon it.
...
The fact that the predicted models seems to confirm the theorized behavior provides confidence in the models.  I have a graph that I feel will give me good estimates on predicted water levels that I can use to predict flooding on my property and home.
